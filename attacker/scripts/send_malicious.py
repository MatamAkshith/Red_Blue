"""Script to execute the synthetic malicious email attack scenario."""
...
def main() -> None:
    ...
    print(f"Payload: Synthetic malicious email ({payload.get('attachment_ref')})")

    result = send_payload("malicious_email.json", config)
